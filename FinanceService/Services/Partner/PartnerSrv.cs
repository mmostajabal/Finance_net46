...
namespace FinanceService.Services.Partner
{
    public class PartnerSrv : IPartner
    {
        ...
        private void GenerateFeePercent(List<decimal> feePercent, int numberFeePercent)
        {
            ...
            {
                feePercent.Add(Math.Round(GlobalMethod.GetRandom(1, 20), 2));
            }
        ...
        /// <param name="PartnerId"></param>
        /// <returns></returns>
        public PartnersDTO GetPartner(decimal PartnerId)
        {
            return GlobalVariables.PARTNER_LIST.FirstOrDefault(o => o.Partner_Id == PartnerId);
        }
    }
}
